...
- search by author would searchby on author column, generate SQL
...
- Handling json with a library is like ajobject, jarray, jproprty
...
- You can use dynamic interface type arugment for var
. Extension methods
